    ...
    <tr>
      <td>
        ...
        <table width="164px" align="center" border="0" style="text-align:left; margin-top:15px; margin-bottom:10px">
          <tr>
            <td width="57px"><img  src="<?php echo $siteUrl;?>da/images/shop/photo750_01.gif" width="56" height="21" style="vertical-align:top;"></td>
        ...
        <table width="164" border="0" align="center" style="margin-bottom:10px">
          <tr>
            <td><a href="#"><img  src="<?php echo $siteUrl; ?>da/images/shop/photo750_02.gif" width="150" height="38" border="0"></a></td>
          </tr>
        </table>
