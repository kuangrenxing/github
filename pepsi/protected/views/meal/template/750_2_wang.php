      ...
      <tr valign="top">
        ...
        <td width="160" >
        	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="200" >
              <tr>
                <td valign="top" style="line-height:21px"><img src="<?php echo $siteUrl;?>da/images/wang/hot_v2.gif"  align="top" >
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td><a href="<?php echo $mealList->detail_url;?>" target="_blank"><img border="0" height="38" src="<?php echo $siteUrl;?>da/images/wang/photo750_02.gif" width="150"></a></td>
              </tr>
              <tr>
                <td><img  src="<?php echo $siteUrl;?>da/images/wang/photo750_03.gif" style="padding-right:3.0px;" ><img  src="<?php echo $siteUrl;?>da/images/wang/photo750_04.gif" style="padding-right:3.0px;" ><img  src="<?php echo $siteUrl;?>da/images/wang/photo750_05.gif"></td>
              </tr>
              <tr>
              	<td>&nbsp;</td>
              </tr>
