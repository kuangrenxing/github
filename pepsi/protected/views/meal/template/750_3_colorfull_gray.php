...
<table width="750" align="center" height="280" border="0" cellspacing="0" cellpadding="0" background="<?php echo $siteUrl;?>da/images/colorfull/bj_02.gif" style="background-repeat:no-repeat; font-size:12px">
  <tbody>
    <tr height="10">
    </tr>
    <tr>
