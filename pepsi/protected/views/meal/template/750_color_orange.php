  ...
  <tr height="23"></tr>
    <tr>
      ...
      <?php
        ...
        '{price}'       =>isset($items[$i]) ? '<a href="'.(isset($items[$i]) ? $items[$i]->detail_url:'#none').'" target="_blank" style="text-decoration:none; color:#000; display:block; width:106px; height:1px;  padding:82px 0 5px 0;"><span style="background-color:#faa020; color:#FFF;display:block ; width:45px; text-align:center;"> ￥'.XHtml::formatPrice($items[$i]->price).' </span></a>':'',
      ...
      <td width="120" align="center" valign="middle">
        <table width="100%" height="130" border="0" cellspacing="0" cellpadding="0" align="center" style="text-align:center;">
          <tbody>
            <tr>
              <td><font style="color:#faa020; font-size:22px;"><strong>套餐价</strong></font> </td>
            </tr>
            <tr>
              <td><font style="color:#faa020; font-size:22px;"><strong>￥<?php echo XHtml::formatPrice($mealList->meal_price)?> </strong></font></td> 
            </tr>
            <tr>
              <td align="left"  style="padding-left:18px;"><font style="color:#ccc;"><strong>节省：</strong></font><font style="color:#faa020"><strong>￥<?php echo XHtml::formatPrice($mealList->origi_price-$mealList->meal_price);?></strong></font></td>
            </tr>
            <tr>
            ...
            <tr>
              <td height="40" valign="bottom"><a href="<?php echo $mealList->detail_url;?>" target="_blank"><img src="<?php echo $siteUrl;?>da/images/color/btn_orange_v1.gif" border="0"></a></td>
            </tr>
        </tbody></table>
      </td>
    </tr>
