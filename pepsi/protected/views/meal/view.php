    ...
    <div class="col-main">
      <div class="main-wrap tj_c w928  h70">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="70px">
          <tbody><tr>
              <td width="29%"><a href="/da/meal/index"><img src="/da/images/btn_back.gif" class="vam"></a></td>
              ...
              <td width="11%"> <a href="/da/meal/update/meal/<?php echo $mealId;?>/template/<?php echo $templateId; ?>">
...
<div class="view950">
  <div class="view_mbox">
    ...
    ?>
      ...
      <div class="fabu"><a href=" <?php if(Yii::app()->user->getState('grade')>0){?> /da/publish/index/meal/<?php echo $mealId.'/template/'.$templateId;?><?php }else{ echo "/da/price"; } ?>" ><img src="/da/v2/images/fabu.png"></a></div>
    </div>
  </div>
