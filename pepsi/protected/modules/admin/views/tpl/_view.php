<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('group_slug')); ?>:</b>
	<?php echo CHtml::encode($data->group_slug); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('item_count')); ?>:</b>
	<?php echo CHtml::encode($data->item_count); ?>
	<br />
